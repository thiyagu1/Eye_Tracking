...
int main(int argc, char** argv)
{
   ...
   string filename = "/Users/thiyaga/Desktop/Eye.mov";
   ...
   for(;;)
   {
       ...
       myfile.open ("/Users/thiyaga/Desktop/Position.txt", std::ofstream::out);
       ...
       for( size_t i = 0; i < circles.size(); i++ )
       {
           ...
           //          pass(x, y, r);
           cout<<"Position X="<<x<<"Position Y="<<y<<endl;//"          "<<"radius="<<radius<<endl;
           // circle outline
